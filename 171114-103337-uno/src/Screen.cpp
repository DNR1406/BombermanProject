...
void Screen::readFromSDCard(char *file) {
   int x, i;
...
uint8_t Screen::OpenBMPFile(char *file, int16_t x, int16_t y)
{
  File myFile;
...
void Screen::drawStartscreenButtons() {
  // Draws start button
